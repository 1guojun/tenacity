...
public:
	...
	static inline size_t _RoundUp(size_t bytes, size_t align) //排列
	{
...
{
#ifdef _WIN32
	void* ptr = VirtualAlloc(0, kpage*(1 << PAGE_SHIFT),   // 向系统申请内存空间
